...
import com.heshi.nls.business.enums.FiletransLangEnum;
...
public class NlsUtil {
    ...
    public static CommonResponse trans(String fileLink, String appKey) {
        try {
            ...
            // taskObject.put("file_link", "https://heshi-test.oss-cn-shanghai.aliyuncs.com/nls-test/nls-sample-16k.wav");  // 设置录音文件的链接
